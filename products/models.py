...
class Product(models.Model):
    ...
    name = models.CharField(max_length=200)
    slug = models.SlugField(max_length=200, unique=True, blank=True)
    sku = models.CharField(max_length=100, unique=True, help_text="Base SKU for the product group.")
    ...
    def is_available(self):
        ...
        return self.is_active and self.variants.filter(is_active=True, stock__gt=0).exists()
...
class ProductImage(models.Model):
    ...
    display_order = models.IntegerField(default=0, name="order") # Keep your field name 'order'
    created_at = models.DateTimeField(auto_now_add=True)
